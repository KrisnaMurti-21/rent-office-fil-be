    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Textarea::make('about')->required()->required()->rows(10)->cols(20),
                ...
                Select::make('is_full_booked')->options([
                    true => 'Not Available',
                    false => 'Available'
                ])
            ]);
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                IconColumn::make('is_full_booked')->boolean()->trueColor('danger')->falseColor('success')->trueIcon('heroicon-o-x-circle')->falseIcon('heroicon-o-check-circle')->label('Available'),
            ])
            ->filters([
